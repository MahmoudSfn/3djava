package underwaterExplorer.BasicMovement.SimEntity.Ocean.Representation3D;
...
public class EntityOcean3DRepresentation extends Representation3D {
	...
	public void init(Group world, Object obj) {
		...
		double size = 200; //reduit d'un facteur 100 pour des rasions de visibilite
		double epaisseurs = 30;// (zone tres large autrement)
		Group g = new Group();
