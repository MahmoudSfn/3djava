...
import underwaterExplorer.BasicMovement.SimEntity.Bouee.Representation3D.IBoueeRepresentation3D;
...
//		Logger.Data(this);
	...
	@Override
	public int getType() {
		return ((BoueeInit) getInitParameters()).getType();
	}
